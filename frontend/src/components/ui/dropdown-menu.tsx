...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ...
    className={cn(
      "z-50 min-w-[8rem] overflow-hidden rounded-xl border border-(--ds-border-subtle) bg-popover p-1.5 text-popover-foreground shadow-(--ds-shadow-dropdown)",
...
const DropdownMenuItem = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DropdownMenuPrimitive.Item> & {
    inset?: boolean;
    /** "destructive" renders the item in danger styling (antd `danger`). */
