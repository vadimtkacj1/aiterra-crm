    ...
    <div dir="rtl" style={{ fontFamily: "Arial, 'Segoe UI', sans-serif", background: "#f5f7fa" }}>
        ...
        <Row gutter={[24, 24]}>
          {[
            ...
            <Col xs={24} sm={12} key={title}>
              <Card variant="borderless" style={{ height: "100%", border: "1px solid #e5e7eb" }}>
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "56px 24px" }}>
        ...
        <Row gutter={[24, 24]} justify="center">
          <Col xs={24} md={8}>
            <Card variant="borderless" style={{ textAlign: "center", border: "1px solid #e5e7eb" }}>
          ...
          <Col xs={24} md={8}>
            <Card variant="borderless" style={{ textAlign: "center", border: "2px solid #1677ff" }}>
