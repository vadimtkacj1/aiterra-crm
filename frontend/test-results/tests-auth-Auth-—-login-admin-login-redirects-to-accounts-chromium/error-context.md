...
- Name: tests\auth.spec.ts >> Auth — login >> admin login redirects to /accounts
- Location: e2e\tests\auth.spec.ts:43:3
...
Expected: "http://localhost:5173/accounts"
Received: "http://localhost:5173/login"
Timeout:  5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    3 × unexpected value "http://localhost:5173/admin/statistics"
