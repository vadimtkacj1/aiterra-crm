...
- Name: tests\billing-checkout.spec.ts >> Billing checkout page >> shows error message when hosted checkout API fails
- Location: e2e\tests\billing-checkout.spec.ts:54:3
...
- main:
  ...
  - alert:
    - img "info-circle"
    - text: New here? Use «Help & CRM guide» in the menu for a visual tour, or complete the quick start checklist above your pages.
    - link "Help & CRM guide":
      - /url: /help
  - img "Aiterra CRM"
  - list:
